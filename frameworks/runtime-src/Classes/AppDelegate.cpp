...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("zgzGame");
#else
        glview = cocos2d::GLViewImpl::createWithRect("zgzGame", Rect(0,0,960,640));
#endif
    ...
    //pingpp
    sc->addRegisterCallback(register_jsb_payment_pingpp);
    //erun sdk
    sc->addRegisterCallback(register_jsb_erun_sdk_all);

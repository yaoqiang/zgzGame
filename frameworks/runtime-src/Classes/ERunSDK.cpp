...
bool jsb_open_browser(JSContext *cx, uint32_t argc, jsval *vp) {
    ...
    if (argc == 1) {
        ...
        if (isExsit)
        {
            ...
            bool isOpenBrowserExsit = cocos2d::JniHelper::getMethodInfo(methodInfo, "org/cocos2dx/javascript/AppActivity", "openBrowser", "(Ljava/lang/String;)V");
            
            if (isOpenBrowserExsit)
            {
